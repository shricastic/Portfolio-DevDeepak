...
<video poster="pdf-reader.png" className="w-full" controls>
  <source src="/pdf-reader.mp4" type="video/mp4"></source>
</video>
...
export default ({ children }) => (
  <div className="prose !max-w-screen-lg w-full [&>h1]:text-purple-700 p-4  bg-black text-white [&_:is(code,strong)]:text-white">
    {children}
  </div>
);
