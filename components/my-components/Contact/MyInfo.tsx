...
export default function MyInfo({}: Props): ReactElement {
  return (
    <div className="space-y-16 py-4">
      <div className="border border-white/50 shadow-white/50 shadow-md p-2 rounded-md">
        <svg
          fill="#FFD700"
          className="h-16 w-16"
          viewBox="0 0 32 32"
      ...
      <div className="space-y-8">
        <div className="flex items-center  gap-4">
          ...
          <span className="text-2xl">deepakbhattarai289@gmail.com</span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-2xl">Jhapa,Nepal</span>
        </div>
      </div>
    </div>
  );
