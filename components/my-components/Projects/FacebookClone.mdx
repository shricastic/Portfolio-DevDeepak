...
export default ({ children }) => (
  <div className="prose sticky top-0 h-screen w-[45%] max-w-max overflow-y-scroll p-4 text-white scrollbar-w-2 scrollbar-thumb-rounded-full scrollbar-thumb-gray-400 scrollbar-track-black  [&>h1]:text-blue-500">
    {children}
  </div>
);
